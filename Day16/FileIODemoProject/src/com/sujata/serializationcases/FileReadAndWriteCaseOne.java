...
public class FileReadAndWriteCaseOne {
    public static void main(String[] args) {
        ...
        try (FileOutputStream fileOutputStream=new FileOutputStream("PersonData");
            ...
            NonSerializedEmployee nonSerializedEmployee=new NonSerializedEmployee(1,"ABC","Sales",7890.0);
        ...
        try {
            ...
            NonSerializedEmployee person=(NonSerializedEmployee) objectInputStream.readObject();
